...
INSERT INTO `antrian` VALUES (1,'UM-001',1,1,1,1,'2026-06-05','NORMAL','MENUNGGU','2026-06-05 22:00:05',NULL,NULL,'Demam','MASTER-1',1),(2,'GG-001',2,2,2,2,'2026-06-05','NORMAL','DIPANGGIL','2026-06-05 21:40:05','2026-06-05 21:55:05',NULL,'Sakit gigi','MASTER-1',1),(3,'KIA-001',3,3,3,3,'2026-06-05','DARURAT','MENUNGGU','2026-06-05 21:50:05',NULL,NULL,'Kontrol','MASTER-1',1),(4,'LAB-001',4,4,4,1,'2026-06-05','NORMAL','SELESAI','2026-06-05 21:00:05','2026-06-05 21:15:05','2026-06-05 21:35:05','Cek darah','MASTER-1',1);
...
INSERT INTO `audit_antrian` VALUES (1,1,'INSERT',NULL,'MENUNGGU',NULL,'{\"status\": \"MENUNGGU\", \"id_pasien\": 1, \"id_layanan\": 1, \"no_antrian\": \"UM-001\"}','sistem','2026-06-05 22:00:05'),(2,2,'INSERT',NULL,'DIPANGGIL',NULL,'{\"status\": \"DIPANGGIL\", \"id_pasien\": 2, \"id_layanan\": 2, \"no_antrian\": \"GG-001\"}','sistem','2026-06-05 22:00:05'),(3,3,'INSERT',NULL,'MENUNGGU',NULL,'{\"status\": \"MENUNGGU\", \"id_pasien\": 3, \"id_layanan\": 3, \"no_antrian\": \"KIA-001\"}','sistem','2026-06-05 22:00:05'),(4,4,'INSERT',NULL,'SELESAI',NULL,'{\"status\": \"SELESAI\", \"id_pasien\": 4, \"id_layanan\": 4, \"no_antrian\": \"LAB-001\"}','sistem','2026-06-05 22:00:05');
...
INSERT INTO `backup_log` VALUES (1,'simak_terpadu_auto_20260605_220005.sql','storage/backups/otomatis','','BERHASIL','Log backup otomatis dari MySQL Event Scheduler','2026-06-05 22:00:05'),(2,'simak_terpadu_backup_2026-06-05_15-05-50.sql','C:\\laragon\\www\\SIMAK_FIX\\actions/../storage/backups\\simak_terpadu_backup_2026-06-05_15-05-50.sql','WEB','BERHASIL','Backup database berhasil dibuat dari halaman laporan admin.','2026-06-05 22:05:50');
...
INSERT INTO `dokter` VALUES (1,'D-001','dr. Nadira Putri','Dokter Umum',1,'0811111111','nadira@klinik.test','Senin-Jumat 08.00-12.00','aktif','2026-06-05 22:00:05'),(2,'D-002','drg. Rangga Mahesa','Dokter Gigi',2,'0822222222','rangga@klinik.test','Selasa-Kamis 09.00-13.00','aktif','2026-06-05 22:00:05'),(3,'D-003','dr. Safira Aulia','KIA',3,'0833333333','safira@klinik.test','Senin-Rabu 10.00-14.00','aktif','2026-06-05 22:00:05'),(4,'D-004','Analis Raka','Laboratorium',4,'0844444444','raka@klinik.test','Setiap hari 08.00-15.00','aktif','2026-06-05 22:00:05');
...
INSERT INTO `log_aktivitas` VALUES (1,'INSERT','pasien','Pasien baru: Alya Maharani','2026-06-05 22:00:05'),(2,'INSERT','pasien','Pasien baru: Bima Pratama','2026-06-05 22:00:05'),(3,'INSERT','pasien','Pasien baru: Citra Lestari','2026-06-05 22:00:05'),(4,'INSERT','pasien','Pasien baru: Dimas Saputra','2026-06-05 22:00:05'),(5,'INSERT','rekam_medis','Rekam medis pasien ID 4 ditambahkan','2026-06-05 22:00:05');
...
INSERT INTO `log_status_antrian` VALUES (1,1,NULL,'MENUNGGU','Antrian dibuat otomatis oleh trigger.','2026-06-05 22:00:05'),(2,2,NULL,'DIPANGGIL','Antrian dibuat otomatis oleh trigger.','2026-06-05 22:00:05'),(3,3,NULL,'MENUNGGU','Antrian dibuat otomatis oleh trigger.','2026-06-05 22:00:05'),(4,4,NULL,'SELESAI','Antrian dibuat otomatis oleh trigger.','2026-06-05 22:00:05');
...
INSERT INTO `log_stok_obat` VALUES (1,1,'masuk',100,0,100,'Stok awal obat baru','2026-06-05 22:00:05'),(2,2,'masuk',40,0,40,'Stok awal obat baru','2026-06-05 22:00:05'),(3,3,'masuk',20,0,20,'Stok awal obat baru','2026-06-05 22:00:05');
...
INSERT INTO `obat` VALUES (1,'OBT-001','Paracetamol 500mg','Tablet','strip',100,10,12000.00,'2026-06-05 22:00:05'),(2,'OBT-002','Amoxicillin 500mg','Kapsul','strip',40,10,18000.00,'2026-06-05 22:00:05'),(3,'OBT-003','Vitamin C','Tablet','botol',20,5,25000.00,'2026-06-05 22:00:05');
...
INSERT INTO `pasien` VALUES (1,'1871010101010001','RM-00001','Alya Maharani','P','2004-03-01','081234567890','081234567890','Jl. Mawar No. 1','Tanjung Karang','O','-','2026-06-05 22:00:05'),(2,'1871010101010002','RM-00002','Bima Pratama','L','2002-07-12','081298765432','081298765432','Jl. Melati No. 2','Rajabasa','A','-','2026-06-05 22:00:05'),(3,'1871010101010003','RM-00003','Citra Lestari','P','1998-11-21','082112223333','082112223333','Jl. Kenanga No. 3','Kedaton','B','Debu','2026-06-05 22:00:05'),(4,'1871010101010004','RM-00004','Dimas Saputra','L','1995-05-20','083145678999','083145678999','Jl. Anggrek No. 4','Way Halim','AB','-','2026-06-05 22:00:05');
...
INSERT INTO `rekam_medis` VALUES (1,4,4,4,'2026-06-05','Pasien datang untuk cek darah','Kondisi stabil','Pemeriksaan laboratorium','Pengambilan sampel darah','-','Hasil menyusul','120/80',36.7,80,68.50,170.00,'2026-06-05 22:00:05');
...
INSERT INTO `repl_event_log` VALUES (1,'MASTER-1','antrian','INSERT','1','e8c70e9900565fda3dee12e86a8c3ea619843ac5f2e7ef7cd6f7fa527d744805','2026-06-05 22:00:05'),(2,'MASTER-1','antrian','INSERT','2','945a808123c33c7a3ea20ffae87e91b6358583ce4ba4a8d5ba2f36328ff8eae0','2026-06-05 22:00:05'),(3,'MASTER-1','antrian','INSERT','3','7a8f5521ab121c8b11894cae86f948cd66d0609dc6d3775ae9cc483c589d30f2','2026-06-05 22:00:05'),(4,'MASTER-1','antrian','INSERT','4','8bc46d36a0b8e396967297490c69767013e8df3cf67142c497b24225b4e99eb2','2026-06-05 22:00:05');
...
INSERT INTO `tagihan` VALUES (1,4,4,25000.00,50000.00,0.00,0.00,75000.00,'lunas','Tunai',75000.00,0.00,'2026-06-05 22:00:05','Tagihan lab','2026-06-05 22:00:05');
...
INSERT INTO `users` VALUES (1,'Administrator','admin','$2y$12$kMEJuP8iRKVjRzYY6hQzOOJQoXpJtjnT6wzdT4O9rrUW9bbO73CTi','admin','aktif','2026-06-05 22:00:05'),(2,'Resepsionis Klinik','resepsionis','$2y$12$fO.JsdPwu6H4cGSNTOimwuaw0WFBhcm2i8ZBBcdbP1m3674Iel4Si','resepsionis','aktif','2026-06-05 22:00:05'),(3,'Pasien Demo','pasien','$2y$12$wpa/FfSh.faFiRdD9SUFaOCCkQf/7WSMq0EENcG7.YkeJRVecru3e','user','aktif','2026-06-05 22:00:05'),(4,'Putri Maharani','ranikece','$2y$10$iEqvu78ZybeapQ.oQOQYAOboueFr9NdxlbnCbuLE7Qv3YuSH9zicS','user','aktif','2026-06-05 22:03:50');
...
-- Dump completed on 2026-06-05 23:00:55
